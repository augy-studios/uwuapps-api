...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=caesar&text=HELLO&shift=3"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=rot13&text=HELLO"
```
...
curl "https://api.uwuapps.org/convert/cipher?alg=a1z26&text=HELLO&mode=encode"

# Decode: "8-5-12-12-15" → "HELLO"
curl "https://api.uwuapps.org/convert/cipher?alg=a1z26&text=8-5-12-12-15&mode=decode"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=vigenere&text=HELLO&key=SECRET"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=affine&text=HELLO&a=5&b=8"
```
...
curl "https://api.uwuapps.org/convert/cipher?alg=bacon&text=HELLO&mode=encode"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=railfence&text=HELLO&rails=3"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=submono&text=HELLO&map=ZYXWVUTSRQPONMLKJIHGFEDCBA"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=polybius&text=HELLO"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=tap&text=HELLO&mode=encode"
```
...
curl "https://api.uwuapps.org/convert/cipher?alg=nato&text=SOS&mode=encode"
```
...
```bash
curl "https://api.uwuapps.org/convert/cipher?alg=enigma&text=HELLO&rotors=I-II-III&pos=A-A-A"
```
