...
```bash
curl "https://api.uwuapps.com/api/calc/interest?principal=1000&rate=5&time=3&duration=year"
```

**Monthly rate for 12 months:**

```bash
curl "https://api.uwuapps.com/api/calc/interest?principal=1000&rate=5&time=12&duration=month"
```
